 ...
 *
 * By truncating the Gaussian to a finite support, a finite impulse response
 * (FIR) filter can approximate Gaussian convolution,
 * \f[ H(z)=\tfrac{1}{s(r)}\sum_{n=-r}^r G_\sigma(n) z^{-n}, 
\quad s(r)=\sum_{n=-r}^{r} G_\sigma(n). \f]
 * 
