 ...
 * for n = 0, ..., N-1 where \f$ \delta \f$ is the unit impulse.  In
 * the denominator coefficient array, element a[0] is not used.
 */
 ...
 * \param a denominator coefficients
 * \param q largest delay of the denominator
 * \param sum the L1 norm of the impulse response
...
/**
 * \brief Scale a strided array
 * \param dest destination array
 * \param src source array, modified in-place if src = dest
 * \param N number of elements
 * \param stride the stride between successive elements
 * \param scale multiply src elements by this scale factor
 */
